...
def load_data():
    ...
    if not os.path.exists(file_path):
        st.error("Fatal Error: The data file 'spi_data.parquet' was not found. The application cannot start.")
        st.stop()
...
# This list must exactly match the keys in the dictionary below
...
# This dictionary must have a key for every option in 'analysis_options'
...
plot_function = plot_function_mapping[analysis_choice]
